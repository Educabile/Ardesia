...
;Extra Files
;Source: "C:\Users\salvatore\Desktop\Ardesia_installer\media.player.codec.pack.v4.4.7.setup.exe"; DestDir: "{tmp}"; Flags: ignoreversion
;Source: "C:\Users\salvatore\Desktop\Ardesia_installer\Nextcloud-2.3.2.1-setup.exe"; DestDir: "{tmp}"; Flags: ignoreversion
;Source: "C:\Users\salvatore\Desktop\Ardesia_installer\vlc-2.2.6-win32.exe"; DestDir: "{tmp}"; Flags: ignoreversion
Source: "C:\Users\salvatore\Desktop\Ardesia_installer\Nextcloud.bkm"; DestDir: "C:\Users\{username}\Nextcloud\Ardesia\bookmark"  
Source: "C:\Users\salvatore\Desktop\Ardesia_installer\Canva.bkm"; DestDir: "C:\Users\{username}\Nextcloud\Ardesia\bookmark"
Source: "C:\Users\salvatore\Desktop\Ardesia_installer\Timeline.bkm"; DestDir: "C:\Users\{username}\Nextcloud\Ardesia\bookmark"
Source: "C:\Users\salvatore\Desktop\Ardesia_installer\Immagini_Interattive.bkm"; DestDir: "C:\Users\{username}\Nextcloud\Ardesia\bookmark"
Source: "C:\Users\salvatore\Desktop\Ardesia_installer\Questionari.bkm"; DestDir: "C:\Users\{username}\Nextcloud\Ardesia\bookmark"
Source: "C:\Users\salvatore\Desktop\Ardesia_installer\UniboardUser.config"; DestDir: "C:\Users\{username}\Nextcloud\Ardesia";  AfterInstall: CreateConfigUser;
...
;Filename: "{tmp}\media.player.codec.pack.v4.4.7.setup.exe"; Parameters: /norestart; Flags: waituntilterminated
;Filename: "{tmp}\Nextcloud-2.3.2.1-setup.exe"; Parameters: /norestart; Flags: waituntilterminated
;Filename: "{tmp}\vlc-2.2.6-win32.exe"; Parameters: /norestart; Flags: waituntilterminated
...
begin
  ...
  Strings[0] := '[Import]';
  Strings[1] := 'LastImportFilePath=' + 'C:/Users/'+ExpandConstant('{username}')+'/Nextcloud/Ardesia';
  Strings[2] := 'LastImportFolderPath=' + 'C:/Users/'+ExpandConstant('{username}')+'/Nextcloud/Ardesia';
  Strings[3] := '';
  Strings[4] := '[Export]';
  Strings[5] := 'LastExportFilePath=' + 'C:/Users/'+ExpandConstant('{username}')+'/Nextcloud/Ardesia';
  Strings[6] := 'LastExportDirPath=' + 'C:/Users/'+ExpandConstant('{username}')+'/Nextcloud/Ardesia';
  Strings[7] := '';
...
begin
  ...
  Strings[7] := '';
  Strings[8] := '';
  Strings[9] := 'EnableStartupHints=false';
