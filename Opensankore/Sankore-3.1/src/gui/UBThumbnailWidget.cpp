...
{
    if(UBApplication::mainWindow->yesNoQuestion(QObject::tr("Rimuovi pagina"), QObject::tr("Sei sicuro di voler rimuovere la pagina dal documento '%0'?").arg(UBApplication::documentController->selectedDocument()->metaData(UBSettings::documentName).toString()))){
