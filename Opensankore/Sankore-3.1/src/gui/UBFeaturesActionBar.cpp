    ...
    , mpNewFolderBtn(NULL)
{
    ...
    // Create the actions
    mpFavoriteAction = new QAction(QIcon(":/images/libpalette/miniFavorite.png"), tr("Aggiungi ai preferiti"), this);
    mpSocialAction = new QAction(QIcon(":/images/libpalette/social.png"), tr("Condividi"), this);
    mpSearchAction = new QAction(QIcon(":/images/libpalette/miniSearch.png"), tr("cerca"), this);
    mpRescanModelAction = new QAction(QIcon(":/images/cursors/rotate.png"), tr("Ripeti ricerca"), this);
    mpDeleteAction = new QAction(QIcon(":/images/libpalette/miniTrash.png"), tr("Cancella"), this);
    mpCloseAction = new QAction(QIcon(":/images/close.svg"), tr("Indietro"), this);
    mpRemoveFavorite = new QAction(QIcon(":/images/libpalette/trash_favorite.svg"), tr("Rimuovi dai preferiti"), this);
    mpNewFolderAction = new QAction(QIcon(":/images/libpalette/miniNewFolder.png"), tr("Crea nuova cartella"), this);
