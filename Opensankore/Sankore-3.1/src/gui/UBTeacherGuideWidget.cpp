  ...
  , mIsModified(false)
{
    ...
    mpPageTitle->setPlaceHolderText(tr("Inserire qui il titolo ..."));
    ...
    mpComment->setPlaceHolderText(tr("Inserire qui i commenti  ..."));
    ...
    mpAddAnActionItem = new UBAddItem(tr("Aggiungi azione"), eUBTGAddSubItemWidgetType_Action, mpTreeWidget);
    mpAddAFileItem = new UBAddItem(tr("Aggiungi file"), eUBTGAddSubItemWidgetType_File, mpTreeWidget); //Issue 1716 - ALTI/AOU - 20140128
    mpAddALinkItem = new UBAddItem(tr("Aggiungi link"), eUBTGAddSubItemWidgetType_Url, mpTreeWidget);
...
void UBTeacherGuideEditionWidget::onActiveSceneChanged()
{
    ...
    if (currentPage > 0) {
        ...
        mpPageNumberLabel->setText(tr("Pagina: %0").arg(currentPage));
...
void UBTeacherGuidePresentationWidget::onAddItemClicked(QTreeWidgetItem* widget, int column)
{
    ...
    if (column == 0 && associateAction != tUBTGActionAssociateOnClickItem_NONE) {
        ...
        case tUBTGActionAssociateOnClickItem_FILE: { //Issue 1716 - ALTI/AOU - 20140128
            ...
            {
                UBApplication::showMessage(tr("File non trovato"));
            }
            else
            {
                ...
                if ( ! QDesktopServices::openUrl(QUrl("file:///" + fullPathFile)) ){
                    UBApplication::showMessage(tr("Nessuna applicazione può gestire questo file"));
                }
                setCursor(oldCursor);
            }
            break;
  ...
  , mIsModified(false)
{
    ...
    mpPageNumberLabel->setAlignment(Qt::AlignRight);
    mpPageNumberLabel->setObjectName("UBTGPageNumberLabel");
    mpPageNumberLabel->setText(tr("Titolo"));
    mpLayout->addWidget(mpPageNumberLabel);
    ...
    mpSessionTitle->setPlaceHolderText(tr("Inserire il titolo"));
    ...
    mpAuthorsLabel->setText(tr("Autore/i"));
    ...
    mpAuthors->setPlaceHolderText(tr("Inserire qui gli autori"));
    ...
    mpObjectivesLabel->setText(tr("Obiettivi"));
    ...
    mpObjectives->setPlaceHolderText(tr("Inserire qui gli obiettivi..."));
    ...
    mpIndexLabel->setText(tr("Indicizzazione Risorse"));
    ...
    mpKeywordsLabel->setText(tr("Parole chiave:"));
    ...
    mpKeywords->setPlaceHolderText(tr("Inserire le parole chiave"));
    ...
    mpSchoolLevelItemLabel->setText(tr("Livello:"));
    ...
    mpSchoolSubjectsItemLabel->setText(tr("Soggetto:"));
    ...
    mpSchoolTypeItemLabel->setText(tr("Tipo:"));
    ...
    mpLicenceLabel->setText(tr("Licenza"));
