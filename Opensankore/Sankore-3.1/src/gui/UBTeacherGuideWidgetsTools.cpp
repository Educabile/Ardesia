    ...
    , mPath("")
{
    ...
    mpTitreFichier->setPlaceholderText(tr("Inserire il nome del file..."));
...
void UBTGFileWidget::OnClickBtnSelectFile()
{
    ...
    QString filename = QFileDialog::getOpenFileName(UBApplication::mainWindow, tr("Selziona il file"), QString(), "*.*", NULL);
