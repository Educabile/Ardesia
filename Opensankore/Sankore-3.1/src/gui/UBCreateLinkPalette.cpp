...
void UBCreateLinkPalette::init()
{
    ...
    QCheckBox* nextPageCheckBox = new QCheckBox(tr("Pagina Successiva"),this);
    ...
    QCheckBox* previousPageCheckBox = new QCheckBox(tr("Pagina Precedente"),this);
    ...
    QCheckBox* firstPageCheckBox = new QCheckBox(tr("Pagina Iniziale"),this);
    mButtonGroup->addButton(firstPageCheckBox,eMoveToFirstPage);
    pageLinkWidgetLayout->addWidget(firstPageCheckBox);
    QCheckBox* lastPageCheckBox = new QCheckBox(tr("Ultima Pagina"),this);
    ...
    QCheckBox* pageNumberCheckBox = new QCheckBox(tr("Numero di Pagina"),this);
    ...
    mUrlLineEdit->setPlaceholderText(tr("Inserisci qua l'url "));
