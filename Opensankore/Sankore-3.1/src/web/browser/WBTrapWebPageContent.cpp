    ...
    , mController(controller)
{
    ...
    buttonLabels << new QLabel(tr("Download in\nlibreria"));
    ...
    buttonLabels << new QLabel(tr("Aggiungi a\nlibreria"));
    ...
    mSelectContentLabel = new QLabel(tr("Selezione contenuti da catturare:"));
    ...
    mApplicationNameLabel = new QLabel(tr("Nome Applicazione"));
