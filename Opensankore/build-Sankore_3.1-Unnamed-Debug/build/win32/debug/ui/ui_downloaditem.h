...
public:
    ...
    WBSqueezeLabel *fileNameLabel;
    QProgressBar *progressBar;
    WBSqueezeLabel *downloadInfoLabel;
    ...
    void setupUi(QWidget *DownloadItem)
    {
        ...
        fileIcon->setText(QString::fromUtf8("Ico"));

        horizontalLayout->addWidget(fileIcon);

        verticalLayout_2 = new QVBoxLayout();
        verticalLayout_2->setObjectName(QString::fromUtf8("verticalLayout_2"));
        fileNameLabel = new WBSqueezeLabel(DownloadItem);
        ...
        downloadInfoLabel = new WBSqueezeLabel(DownloadItem);
