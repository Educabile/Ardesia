...
public:
    ...
    void retranslateUi(QFrame *brushProperties)
    {
        ...
        darkBackgroundLabel->setText(QApplication::translate("brushProperties", "<html><head/><body><p><span style=\" color:#ffffff;\">On Dark Background</span></p></body></html>", 0, QApplication::UnicodeUTF8));
