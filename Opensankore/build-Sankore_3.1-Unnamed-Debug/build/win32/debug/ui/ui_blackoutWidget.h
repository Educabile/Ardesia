...
**
** Created: Mon 20. Nov 11:15:25 2017
...
public:
    ...
    void setupUi(QWidget *BlackoutWidget)
    {
        ...
        iconButton->setStyleSheet(QString::fromUtf8("background: url(:/images/bigUniboard.png); border: none;"));
    ...
    {
        labelClickToReturn->setText(QApplication::translate("BlackoutWidget", "Click to Return to Application", 0, QApplication::UnicodeUTF8));
        Q_UNUSED(BlackoutWidget);
    } // retranslateUi
